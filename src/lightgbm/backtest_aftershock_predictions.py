...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Backtest the production-style LightGBM inference path "
...
def require_backtest_dependencies():
    try:
        import joblib
        import lightgbm as lgb  # noqa: F401  (needed to unpickle the saved models)
        ...
        raise ModuleNotFoundError(
            "LightGBM backtesting requires lightgbm, scikit-learn, and joblib. "
