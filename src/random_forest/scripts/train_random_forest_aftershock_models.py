...
DEFAULT_INPUT_CSV = Path("src/lightgbm/dataset/lightgbm_training_dataset_mc_1_0.csv")
DEFAULT_OUTPUT_DIR = Path("outputs/random_forest_models_mc_1_0")
...
def load_feature_columns(input_csv):
    ...
    if not feature_path.exists():
        raise FileNotFoundError(
            ...
            "Run src/lightgbm/scripts/build_lightgbm_training_dataset.py first."
        )
