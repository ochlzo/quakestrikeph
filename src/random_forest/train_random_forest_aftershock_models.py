...
# TODO(training): Add explicit training for m5_plus_aftershock_24h and a
# deliberate fallback for aftershock_count_24h. Random Forest has no native
# Poisson objective, so use either standard count regression or a log1p target.
