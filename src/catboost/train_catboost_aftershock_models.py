...
# aftershock_count_24h. The count target should use CatBoost Poisson loss where
# supported instead of the current RMSE regressor.
...
def train_regressor(target, train, validation, test, feature_columns, output_dir, args, deps):
    ...
    # keeps zeros, and uses a Poisson objective where available.
