...
# aftershock_count_24h. The count target should use an XGBoost count objective
# such as count:poisson instead of the current square-error regressor.
...
def train_regressor(target, train, validation, test, feature_columns, output_dir, args, deps):
    ...
    # keeps zeros, and uses a Poisson count objective.
